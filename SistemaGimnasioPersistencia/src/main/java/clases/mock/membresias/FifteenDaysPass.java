...
public class FifteenDaysPass extends Membresia {
    ...
    public FifteenDaysPass(double precio, List<ServicioExtra> serviciosExtra, EnumEstadoMembresia estado) {
        super(precio, serviciosExtra, estado);
        super.setId(4);
    }

    public FifteenDaysPass(Date inicio, double precio, List<ServicioExtra> serviciosExtra, EnumEstadoMembresia estado) {
        super(precio, serviciosExtra, estado);
        this.inicio = inicio;
        super.setId(4);
