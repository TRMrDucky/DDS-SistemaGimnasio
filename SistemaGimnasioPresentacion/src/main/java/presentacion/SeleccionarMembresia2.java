...
public class SeleccionarMembresia2 extends javax.swing.JFrame {
     ...
     */
    public SeleccionarMembresia2(ControlNavegacionComprasMembresias control, ClienteRegistradoDTO cliente RegistradoDTO) {
...
//        se.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionarMembresia2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionarMembresia2().setVisible(true);
            }
        });
    }
